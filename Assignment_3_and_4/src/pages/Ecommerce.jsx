        ...
        <div className="bg-white dark:text-gray-200 h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-no-repeat bg-cover bg-center">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-2xl text-gray-600">$ 30,500.00</p>
            </div>
            <button
              type="button"
      ...
      <div className="flex gap-10 flex-wrap justify-center">
        ...
        <div>
          ...
          <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl md:w-400 p-8 m-3 flex justify-center items-center gap-10">
            <div>
              <p className="text-2xl font-semibold">$ 229,360.00</p>
      ...
      <div className="flex gap-10 m-4 flex-wrap justify-center">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg p-6 rounded-2xl">
          ...
          <div className="flex justify-between items-center mt-5 border-t-1 border-color">
            ...
            <p className="text-gray-400 text-sm">16 Recent Transactions</p>
          </div>
        </div>
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg p-6 rounded-2xl w-96 md:w-760">
          <div className="flex justify-between items-center gap-2 mb-10">
            <p className="text-xl font-semibold">Crypto Overview in 4 Months</p>
            <DropDown currentMode={currentMode} />
          </div>
          ...
          <div className="mt-10">
            ...
            <div className="mt-8">
              ...
              <p className="mt-8 text-sm text-gray-400">
                Bitcoin price dropped sharply to the $28,500 support. Ethereum
                dived to $10,265, XRP is down over 20%. QNT and RSR are up over
                10%....
              </p>
              <div className="mt-3">
                <Button
